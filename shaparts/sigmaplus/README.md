...
- makefile
- python_function.py - проверямая circom функция, реализованная на языке программирования python
    - В конце файла должны быть явно объявлены: f - нужная нам функция, params - константы функции. f: (inp, *params) -> out
