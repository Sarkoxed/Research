...
В первом разделе были рассмотрены основные понятия в области ZKP.
Во втором разделе были рассмотрены аспекты программной реализации ZKP в реальном мире.
В третьем разделе был рассмотрен DSL Circom.
В четвертом разделе был проанализирован подход к тестированию при помощи символьного исполнения, а также алгоритм тестирования.
В пятом разделе была представлнеа реализация алгоритма тестирования.
В шестом разделе были представлены результаты тестирования.
